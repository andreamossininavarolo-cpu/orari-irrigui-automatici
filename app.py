...
st.markdown("""
<style>
    /* Riduce la dimensione del titolo principale su cellulare */
    h1 {
        font-size: 1.8em !important;
        margin-bottom: 0px !important;
        padding-bottom: 0px !important;
    }
    /* Forza le colonne dei tre pulsanti a stare affiancate in orizzontale anche su mobile */
    [data-testid="column"] {
        width: calc(33.333% - 6px) !important;
        flex: 1 1 calc(33.333% - 6px) !important;
        min-width: calc(33% - 6px) !important;
    }
    /* Riduce la spaziatura verticale generale */
...
if not df_risultato.empty:
    ...
    if turni_del_giorno.empty:
        ...
        for _, turno in turni_del_giorno.iterrows():
            ...
            # Icone cerchio HTML ad alto contrasto e brillantezza (Neon)
