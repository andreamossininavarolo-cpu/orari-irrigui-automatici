...
st.markdown("""
<style>
    /* Riduci dimensione del titolo e margini */
    h1 {
...
with st.expander("⚙️ Impostazioni", expanded=False):
    # CORREZIONE: REINSERITI I CAMPI MANCANTI
...
# Passiamo la data d'inizio corretta al motore di calcolo
start_stagione = datetime.combine(d_inizio, t_inizio)

with st.expander("📝 Modifica Partenze", expanded=False):
